...
public class Recent {
    ...
    @OneToMany(mappedBy = "recent", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<Reviewrec> reviews = new ArrayList<>();
    
    public List<Reviewrec> getReviews() {
        return reviews;
    }

    public void setReviews(List<Reviewrec> reviews) {
